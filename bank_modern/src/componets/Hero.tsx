      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          ...
          <p className={`${styles.paragraph} ml-2`}>
            ...
            <span className="text-white">1 Mês</span> de Assinatura
          </p>
        </div>

        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100.8px] leading-[75px]">
            A proxima <br className="sm:block hidden" />{" "}
        ...
        Nossa equipe de especialistas utiliza uma metodologia para identificar os cartões de crédito
           provavelmente atenderá às suas necessidades. Examinamos taxas percentuais anuais,
           taxas anuais.
        </p>
      </div>
